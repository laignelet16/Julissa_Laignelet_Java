...
public class CustomerControllerTests {
    ...
    // why: uses mockmvc to save and use post to create customer
    @Test
    ...
    // why: uses mockmvc to save and use put to update and save customer
    @Test
    ...
    public void shouldDeleteCustomer() throws Exception {
        ...
        // Uses MockMVC to perform a DELETE request for the customer and verifies the response status is "No Content."
    ...
    public void shouldGetCustomerById() throws Exception {
        ...
        // Uses MockMVC to perform a GET request for the customer and verifies the response status is "isOK."
    ...
    public void shouldGetCustomerByState() throws Exception {
        ...
        // Uses MockMVC to perform a GET request for the customer through state and verifies the response status is "isOK"
